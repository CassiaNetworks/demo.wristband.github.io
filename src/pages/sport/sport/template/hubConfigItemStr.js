...
module.exports.liItem = ` <li class="hub-item" data-cid=<%= cid %> >
                            <div class="layui-form-item">
                                ...
                                <div>
                                    <input type="radio" name=<%= cid %> lay-filter=<%= cid %>  value="0" i18n="local"   <%- method===0?'checked':'' %> title = '<%= local %>' >
                                    <input type="radio" name=<%= cid %> lay-filter=<%= cid %>  value="1" i18n="remote"  <%- method===1?'checked':'' %> title = '<%= remote %>'>
                                </div>
                            </div>
                            <div class="layui-form-item">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="hubIp" placeholder="192.168.1.100" value='<%= hubIp %>' class="layui-input">
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="password" placeholder="tester" value="" class="layui-input">
                                </div>
                            </div>

                            <div class="layui-form-item test">
                                <button class="layui-btn layui-btn-small" lay-submit lay-filter="s1" data-cid=<%- cid %>><%= test %></button>
                                <div class="layui-input-inline">
                                    <i data-cid=<%= cid %> >OK</i>
                                </div>
                            </div>
                            <div class="layui-form-item delete">
                                <button class="layui-btn layui-btn-small" lay-submit="" class="test"><%= deletes %></button>
                            </div>
