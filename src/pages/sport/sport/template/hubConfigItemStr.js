...
//每个hubitem的字符串          
module.exports.liItem = ` <li class="hub-item">
                            <div class="layui-form-item">
                                <label class="layui-form-label" i18n="control"><%= control %></label>
                                <div>
                                    <input type="radio" name=<%= cid %> value="0" i18n="local"   <%- method===0?'checked':'bb' %> title = '<%= local %>' >
                                    <input type="radio" name=<%= cid %> value="1" i18n="remote"  <%- method===1?'checked':'bb' %> title = '<%= remote %>'>
                                </div>
                            </div>
                            <div class="layui-form-item">
